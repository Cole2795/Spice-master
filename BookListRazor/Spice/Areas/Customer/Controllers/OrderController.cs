...
namespace Spice.Areas.Customer.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        public async Task<IActionResult> Confirm(int id)
        {
            ...
            {
                OrderHeader = await _db.OrderHeaderOrderHeader.Include(o => o.ApplicationUser).FirstOrDefaultAsync(o => o.Id == id && o.UserId == claim.Value),
        ...
        {
            return PartialView("_OrderStatus", _db.OrderHeaderOrderHeader.Where(m => m.Id == Id).FirstOrDefault().Status);
        ...
        public async Task<IActionResult> OrderHistory(int productPage = 1)
        {
            ...
            List<OrderHeader> OrderHeaderList = await _db.OrderHeaderOrderHeader.Include(o => o.ApplicationUser).Where(u => u.UserId == claim.Value).ToListAsync();
        ...
        public async Task<IActionResult> ManageOrder(int productPage = 1)
        {
            ...
            List<OrderHeader> OrderHeaderList = await _db.OrderHeaderOrderHeader.Where(o => o.Status == SD.StatusSubmitted || o.Status == SD.StatusInProcess).OrderByDescending(u => u.PickupTime).ToListAsync();
        ...
        public async Task<IActionResult> GetOrderDetails(int Id)
        {
            OrderDetailsViewModel orderDetailsViewModel = new OrderDetailsViewModel()
            {
                OrderHeader = await _db.OrderHeaderOrderHeader.FirstOrDefaultAsync(m => m.Id == Id),
        ...
        {
            OrderHeader orderHeader = await _db.OrderHeaderOrderHeader.FindAsync(OrderId);
        ...
        public async Task<IActionResult> OrderPickup(int productPage = 1, string searchEmail=null,string searchName=null, string searchPhone=null)
        {
            ...
            if (searchName != null || searchEmail != null || searchPhone != null)
            {
                ...
                if (searchName != null)
                {
                    OrderHeaderList = await _db.OrderHeaderOrderHeader.Include(o => o.ApplicationUser)
            ...
            {
                OrderHeaderList = await _db.OrderHeaderOrderHeader.Include(o => o.ApplicationUser).Where(u => u.Status == SD.StatusReady).ToListAsync();
            }
                foreach (OrderHeader item in OrderHeaderList)
                {
                    OrderDetailsViewModel individual = new OrderDetailsViewModel
